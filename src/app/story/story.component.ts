    ...
    this.apiService
      ...
      .subscribe(response => {
        ...
        if (
          ...
          this.emotions.emotions_detected[0] == "surprise"
        ) {
          this.router.navigate(["/joy"]);
        } else if (
          this.emotions.emotions_detected[0] == "anger" ||
          this.emotions.emotions_detected[0] == "disgust"
        ) {
          this.router.navigate(["/anger"]);
        } else if (
          this.emotions.emotions_detected[0] == "sadness" ||
          this.emotions.emotions_detected[0] == "fear"
        ) {
